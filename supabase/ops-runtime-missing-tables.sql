-- Missing /ops runtime tables for restored Supabase projects.
-- Apply this in Supabase Dashboard → SQL Editor, then run: npm run ops:doctor
-- Idempotent: safe to re-run because tables/indexes use IF NOT EXISTS and agents use ON CONFLICT.
